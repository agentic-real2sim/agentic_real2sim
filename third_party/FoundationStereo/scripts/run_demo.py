...
if __name__=="__main__":
  ...
  if args.get_pc:
    ...
    try:
      ...
      logging.warning(f"Cannot open visualization window (headless environment?): {e}")
      logging.info(f"Point cloud saved to {args.out_dir}/cloud.ply — open it locally to view.")
