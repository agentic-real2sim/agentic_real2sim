...
if __name__=='__main__':
  ...
  parser.add_argument('--mask_root', type=str, default=f'{repo_dir}/FoundationStereo/segment_results_droid')
  parser.add_argument('--mesh_dir', type=str, default=f'{repo_dir}/FoundationStereo/meshes')
  parser.add_argument('--mesh_file', type=str, default=None, help='Optional mesh override. If omitted, uses <mesh_dir>/<object_name>.glb. UV textures and vertex colors are both supported.')
  ...
  parser.add_argument('--debug_dir', type=str, default=f'{code_dir}/debug_foundationstereo')
  args = parser.parse_args()

  if args.mesh_file is None:
    args.mesh_file = f'{args.mesh_dir}/{args.object_name}.glb'

  set_logging_format()
  set_seed(0)

  run_debug_dir = os.path.join(os.path.abspath(args.debug_dir), args.object_name)
  ...
  logging.info(f'Using init_frame={init_frame}, end_frame={end_frame}, object={args.object_name}')
